 ...
 */
const api = 'https://api.pancakeswap.info/api/v2/tokens/0x4ca6b6b8f10eb17dbd1f8c3f313eca2f779c6e0b'

const useGetCrystalPriceData = () => {
...
export default useGetCrystalPriceData